...
namespace Core
{
    ...
    {
        public static ContributeModuleRead ModuleA(ContributeModuleRead module, Int32 TabulationTableLengthA___ITEM, Int32 TabulationTableAddressA____ITEM)
        {
            ...
            using (binaryReader)
            {
                ...
                do
                {
                    ...
                    shouldBreakCheck = TabulationTableLengthA___ITEM.Equals(indexer) is true;
