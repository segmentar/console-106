...
namespace Core
{
    ...
    {
        public static ContributeModuleRead FunctionOne
(
ContributeModuleRead module,
Contribute[] ContributeA__ARRAY,
Contribute[] ContributeB__ARRAY, 
Contribute[] ContributeC__ARRAY, 
Contribute[] ContributeD__ARRAY
)
        {
