...
namespace Core
{
    ...
    {
        public void HVLock(String Filename_VALUE, String[] SplitTruncate__ARRAY)
        {
            try
            {
                ...
                if (isFatalCheck is true)
                {
                    ...
                    HFatal.Action(new HVLockFatal().Initialize(Filename_VALUE, information, default));
            ...
            {
                HFatal.Action(new HVLockFatal().Initialize(Filename_VALUE, new String[0], exception));
            }
