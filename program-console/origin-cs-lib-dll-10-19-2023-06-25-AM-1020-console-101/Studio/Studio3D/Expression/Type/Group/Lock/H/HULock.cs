...
namespace Core
{
    ...
    {
        public void HULock(String Filename_VALUE, String[] SplitTruncate__ARRAY)
        {
            try
            {
                ...
                if (isFatalCheck is true)
                {
                    ...
                    HFatal.Action(new HULockFatal().Initialize(Filename_VALUE, information, default));
                }
                else
                    "false".ToString();
            ...
            {
                HFatal.Action(new HULockFatal().Initialize(Filename_VALUE, new String[0], exception));
            }
