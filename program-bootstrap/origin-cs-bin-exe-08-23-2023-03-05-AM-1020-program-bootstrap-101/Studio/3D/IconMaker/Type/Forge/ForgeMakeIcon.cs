...
namespace Core.DimensionThreeThird
{
    ...
    {
        public static void MakeIcon(String path, Color foregroundColor, Color backgroundColor, Single impact, Int32 scale)
        {      
            Bitmap bitmap;
            ...
            using (bitmap)
            {
                ...
                using (graphics = Graphics.FromImage(bitmap))
                {
                    ...
                    var random = ImmutableOneFirst.ProgramRandom.Next(1, 5);
