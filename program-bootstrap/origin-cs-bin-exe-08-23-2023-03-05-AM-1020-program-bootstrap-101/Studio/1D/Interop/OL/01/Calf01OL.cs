...
namespace Core
{
    ...
    {
        public static void Calf01OL(Int32 ordinal, params String[] array_ARGUMENT)
        {
            var boolean_safe_RETURN_should = false;
            
            boolean_safe_RETURN_should = boolean_safe_RETURN_should || (ordinal > 5) is true;

            boolean_safe_RETURN_should = boolean_safe_RETURN_should || ArchitectureOneFirst.HasEscapeCharacter is false;
