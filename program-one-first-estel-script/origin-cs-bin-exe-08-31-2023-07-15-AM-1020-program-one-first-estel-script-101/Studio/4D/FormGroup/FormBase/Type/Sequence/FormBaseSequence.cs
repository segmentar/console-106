...
namespace Core
{
    ...
    public partial class FormBaseSequence
    {
        ...
        public FormBaseSequence(BaseCFS item__BASE_CFS, Int32[] array_POSITION, Boolean debug)
        {
            ...
            MaterialStringFormat reflectStringFormat;

            reflectStringFormat = new MaterialStringFormat();
                
            reflectStringFormat.StringValue = contentString;

            reflectStringFormat.StringValueFormat = contentString.Trim();

            /*MaterialreflectModule reflectModule;

            reflectModule = MaterialreflectModule.MaterialreflectModuleAction(reflectStringFormat, array_ESCAPE, true);*/
